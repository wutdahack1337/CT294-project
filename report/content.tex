...
Bài toán được đặt ra trong báo cáo này là xây dựng được một mô hình dự đoán, dùng để ước lượng được mức tiêu thụ năng lượng của các thiết bị gia dụng trong một ngôi nhà. Mục tiêu là dự đoán gần chính xác mức tiêu thụ năng lượng dựa trên dữ liệu được thu thập từ các cảm biến nhiệt độ và độ ẩm đặt trong nhà, thông tin thời tiết từ trạm thời tiết gần nhất và dữ liệu tiêu thụ năng lượng của hệ thống chiếu sáng, đồng thời xác định được các yếu tố nào là hiệu quả nhất cho việc dự đoán. Mô hình này nhằm hỗ trợ các ứng dụng quản lý năng lượng, tối ưu hoá hệ thống chiếu sáng, và cải thiện hiệu quả sử dụng năng lượng trong các toà nhà, góp phần nâng cao hiệu quả sử dụng năng lượng trong các khu dân cư.
